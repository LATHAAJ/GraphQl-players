...
#### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">createPlayer</code>.<code class="gqlmd-mdx-entity-name">age</code></span>](#)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">Int</code></span>](/types/scalars/int) <mark class="gqlmd-mdx-badge">scalar</mark> 
